...
class Tenant {
    ...
    static async updateBaseModelSync(status, tenantIdsToUpdate, autoUndeploy = false, advancedOptions = null, context = {}) {
        ...
        const allTenantsIds = await Tenant.getAllTenantIds();
        ...
        if (tenantIdsToUpdate.includes("all")) {
            tenantIdsToUpdate = allTenantsIds;
        }
        ...
        const basemodelTenantIds = tenantIdsToUpdate.filter(tenantId => !extendedTenantIds.includes(tenantId) && allTenantsIds.includes(tenantId) );
