...
class HdiApplicationDataPersistence {
    ...
    static async initGlobalMetaTenantIfNeeded() {
        ...
        const instanceManagerOptions = cds.env.get('mtx.provisioning.metadatacontainer') || {};
        await HdiCommonPersistence.createTenant(this._globalMetaTenantId, instanceManager, TEMPLATE_DIR, { expectedTables: META_TABLES, instanceManagerOptions });
